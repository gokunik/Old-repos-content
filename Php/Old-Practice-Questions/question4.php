...
<head>
    <title>function using php</title>
</head>

<body>
    <center>
        <form method="post">
            <!--here we we created a form through that we will be able to enter user id
            and password-->
            User id
            ...
            <br>
            <input type="submit" name="add" value="Compute">
            <!--to compute wheather the entered user id
